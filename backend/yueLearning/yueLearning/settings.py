...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql', #local ->'django.db.backends.mysql' producción -> 'mysql.connector.django'
        'NAME': config('DB_NAME'),
        'USER': config('DB_USER'),
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:3000",
    "http://127.0.0.1:8000",
    "https://yue-learningc.netlify.app",
    "https://yuelearningc-production.up.railway.app"
]
